...
class FestivalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create festival" do
    assert_difference("Festival.count") do
      post festivals_url, params: { festival: { address: @festival.address, description: @festival.description, name: @festival.name } }
    end
  ...
  test "should update festival" do
    patch festival_url(@festival), params: { festival: { address: @festival.address, description: @festival.description, name: @festival.name } }
